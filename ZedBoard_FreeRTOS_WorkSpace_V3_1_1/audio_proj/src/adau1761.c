...
void adau1761_iis_init(tAdau1761 *pThis) {
	...
	//Reset I2S RX
	Xil_Out32(AXI_I2S_REGISTER(AXI_I2S_REG_RESET), AXI_I2S_RESET_RX_FIFO);
...
void adau1761_iis_rx_enable()
{
	Xil_Out32(AXI_I2S_REGISTER(AXI_I2S_REG_CTRL), AXI_I2S_CTRL_RX_EN);
}
